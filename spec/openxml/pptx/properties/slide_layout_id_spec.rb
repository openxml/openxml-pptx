...
describe OpenXml::Pptx::Properties::SlideLayoutId do
  include PropertyTestMacros

  it_should_use tag: :sldLayoutId, name: "slide_layout_id"
  ...
  for_attribute(:rid) do
    with_value("rId256") do
      it_should_assign_successfully
      its_output_should_match %r{^<p:sldLayoutId id="\d+" r:id="rId256"/>}
    end
