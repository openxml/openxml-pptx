...
describe OpenXml::Pptx::Properties::SlideMasterIdList do
  include PropertyTestMacros

  it_should_use tag: :sldMasterIdLst, name: "slide_master_id_list"
  ...
  context "when there is a child" do
    before(:each) do
      @instance = described_class.new
      instance << OpenXml::Pptx::Properties::SlideMasterId.new.tap do |master_id|
    ...
    it "should output the correct XML" do
      expect(xml(instance)).to eq("<p:sldMasterIdLst>\n    <p:sldMasterId id=\"2147483649\" r:id=\"rId256\"/>\n  </p:sldMasterIdLst>")
    end
  end
end
